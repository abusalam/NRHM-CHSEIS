...
<div class="MenuBar">
	<ul>
		...
		<li
			class="<?php echo ($_SERVER['SCRIPT_NAME']==BaseDIR.'MedTeam.php')?'SelMenuitems':'Menuitems';?>">
			<a href="<?php echo FN\GetAbsoluteURLFolder(); ?>MedTeam.php">Medical Team</a>
		</li>
		<li
			class="<?php echo ($_SERVER['SCRIPT_NAME']==BaseDIR.'AppForm.php')?'SelMenuitems':'Menuitems';?>">
			<a href="<?php echo FN\GetAbsoluteURLFolder(); ?>AppForm.php">Schedule Entry</a>
		</li>
		<li
